    ...
    <div className="mt-10 space-y-4 border border-[#EEEEEE] rounded-sm">
      ...
      <div className="flex justify-center items-center gap-8 md:gap-20 p-4">
        <div className="flex flex-col items-center gap-2">
          <div
            className={`h-4 w-4 rounded-full ${transactionStatus === "Pending" ? "bg-red-500" : "border border-gray-300"}`}
          ></div>
        ...
        <div className="flex flex-col items-center gap-2">
          <div
            className={`h-4 w-4 rounded-full ${transactionStatus === "Confirmed" ? "bg-red-500" : "border border-gray-300"}`}
          ></div>
        ...
        <div className="flex flex-col items-center gap-2">
          <div
            className={`h-4 w-4 rounded-full ${transactionStatus === "Declined" ? "bg-red-500" : "border border-gray-300"}`}
          ></div>
      ...
      <div className="flex justify-center mt-10 pb-3">
        <Button className="bg-red-500 hover:bg-red-600 text-white px-8 rounded-md">
          Update
        </Button>
      </div>
    </div>
