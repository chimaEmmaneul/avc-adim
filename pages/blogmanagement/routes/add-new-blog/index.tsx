  ...
  return (
    <div className="p-6 bg-white border border-gray-200 rounded-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-[150px_1fr] items-center gap-4">
          <label htmlFor="metaImage" className="text-sm font-medium">
            Meta Image <span className="text-gray-500 text-xs">(1200x630)</span>
          </label>
          <div className="flex">
            <input
              type="file"
            ...
            <div className="flex-1 p-2 border border-l-0 border-gray-300 rounded-r text-sm truncate">
              {metaImageFile ? metaImageFile.name : "Choose file"}
            </div>
          </div>
        </div>

        <div className="grid grid-cols-[150px_1fr] items-start gap-4">
          <label htmlFor="metaDescription" className="text-sm font-medium pt-2">
            Meta Description
          </label>
          <textarea
            id="metaDescription"
